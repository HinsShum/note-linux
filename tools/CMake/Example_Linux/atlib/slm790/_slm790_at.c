/**
 * @file atlib/slm790/_slm790_at.c
 *
 * Copyright (C) 2020
 *
...
/*---------- type define ----------*/
/*---------- variable ----------*/
struct st_ryat_ret_describe const ryat_ret_tbl_slm790[] = {
    { RYAT_RET_OK, "OK", 2 },
    { RYAT_RET_ERROR, "ERROR", 5 },
    { RYAT_RET_CME, "+CME", 4 },
    { RYAT_RET_CSQ, "+CSQ", 4 },
    { RYAT_RET_GMM, "+GMM", 4 },
    { RYAT_RET_CCID, "+ICCID", 6 },
...
/*---------- function ----------*/
int32_t _slm790_at_get_data(struct st_ryat_describe *pat, uint8_t channel, uint8_t *pdata, uint16_t len, uint32_t timeout)
{
