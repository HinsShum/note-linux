...
struct st_ryat_ret_describe const ryat_ret_tbl_g500[] = {
    {RYAT_RET_OK, "OK", 2},
...
err_t _g500_at_get_data(struct st_ryat_describe* pat, uint8_t channel, uint8_t* pdata, uint16_t len, uint32_t timeout) {
